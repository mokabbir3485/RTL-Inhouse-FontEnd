<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RV_Pos_DeliveryChallanByDeliveryId.aspx.cs" Inherits="Security.UI.ErpReports.RV_Pos_DeliveryChallanByDeliveryId" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="750px">
            <LocalReport ReportPath="ErpReports\rpt_pos_DeliveryChallanByDeliveryId.rdlc" ReportEmbeddedResource="Security.UI.ErpReports.rpt_pos_DeliveryChallanByDeliveryId.rdlc">
                <DataSources>

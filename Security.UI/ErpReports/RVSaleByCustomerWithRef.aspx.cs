...
{
    public partial class RVSaleByCustomerWithRef : System.Web.UI.Page
    {
        ...
        public string BuyerType = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    BuyerType = Convert.ToString(Request.QueryString["BuyerType"]);
                    BuyerType = BuyerType == "null" ? null : BuyerType;
                }
                catch (Exception)
                {
                    BuyerType = null;
        ...
        protected void ObjectDataSource1_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            ...
            e.InputParameters["BuyerType"] = BuyerType;
        }
    }
}
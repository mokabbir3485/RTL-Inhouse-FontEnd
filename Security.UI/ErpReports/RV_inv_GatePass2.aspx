<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RV_inv_GatePass2.aspx.cs" Inherits="Security.UI.ErpReports.RV_inv_GatePass2" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="508px" Width="831px">
                <LocalReport ReportPath="ErpReports\rpt_inv_GatePass2.rdlc" ReportEmbeddedResource="Security.UI.ErpReports.rpt_inv_GatePass2.rdlc">
                    <DataSources>

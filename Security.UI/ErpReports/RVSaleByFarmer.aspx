<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RVSaleByFarmer.aspx.cs" Inherits="Security.UI.ErpReports.RVSaleByFarmer" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="615px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1340px">
            <LocalReport ReportPath="ErpReports\rptSaleByCustomer.rdlc" ReportEmbeddedResource="Security.UI.ErpReports.rptSaleByCustomer.rdlc">
                <DataSources>

...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ds_hr_SalaryHistory" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Security.UI.App_Code.DataSet.ds_hr_SalaryHistoryTableAdapters.xRpt_hr_SalaryHistoryTableAdapter" OnSelecting="ObjectDataSource1_Selecting">
                <SelectParameters>

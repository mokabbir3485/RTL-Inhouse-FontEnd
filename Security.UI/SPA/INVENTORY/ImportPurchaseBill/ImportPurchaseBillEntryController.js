            ...
            if (flag) {
               ...
               // Item.TotalPBPrice = TotalPBPriceCal;
                ...
                angular.forEach($scope.inv_PurchaseBillDetaillst, function (adata) {
                    ...
                    if ($scope.inv_PurchaseBill.AdditionDiscount == undefined) {
                        ...
                        $scope.aditionalVatWithoutDiscount = ($scope.TotalCostAfterDiscount - $scope.inv_PurchaseBill.AdditionDiscount);
               ...
               // Attribute.TotalCost = $scope.aditionalVatWithoutDiscount;
    ...
    $scope.SavePB = function () {
        ...
        alertify.confirm("Are you sure to save?", function (e) {
            if (e) {
                ...
                if ($scope.inv_PurchaseBill.AdditionDiscount != undefined) {
                    $scope.inv_PurchaseBill.TotalAmountAfterDiscount = $scope.TotalAmountPB - $scope.inv_PurchaseBill.AdditionDiscount;
                    $scope.inv_PurchaseBill.TotalAmount = $scope.TotalAmountPB;
                } else {
                    $scope.inv_PurchaseBill.TotalAmountAfterDiscount = $scope.TotalAmountPB;
                    $scope.inv_PurchaseBill.TotalAmountAfterDiscount = $scope.aditionalVatWithoutDiscount;
                }
               ...
               // $scope.inv_PurchaseBill.PBDate = f;
                $.ajax({
                    ...
                    contentType: "application/json;charset=utf-8",
                    type: "POST",
                    data: JSON.stringify({ ainv_PurchaseBill: $scope.inv_PurchaseBill, inv_PurchaseBillDetailLst: pbListItem, inv_PurchaseBillDetailSerial: warrentyAndSerialList }),
                    success: function (data) {
                        if (data > 0) {
